...
import ForgotPassword from "../Auth/components/Models/ForgotPassword";
  ...
  return (
    <div className="h-full w-full flex justify-center items-center py-16 bg-white">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <h2 className="text-2xl font-semibold text-center mb-2 text-black">Sign in</h2>
        ...
        <form onSubmit={handleLogin}>
          ...
          <button
            ...
            type="submit"
            className="w-full py-2 rounded-lg flex items-center justify-center mb-4"
          >
            Sign in
