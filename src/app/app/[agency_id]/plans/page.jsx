  ...
  return (
    <div className="p-10">
      ...
      <div className="flex justify-center mt-4">
        <span
          className={`cursor-pointer px-4 py-2 ${billingCycle === "monthly"
        ...
        <span
          className={`cursor-pointer px-4 py-2 ${billingCycle === "yearly"
              ? "text-blue-600 font-bold"
              : "text-gray-500"
            }`}
          onClick={() => {
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 mt-8">
        {data
          ...
          .map((product, index) => (
            <div
              key={index}
              className={`p-6 border rounded-lg w-80 text-center shadow-md ${product?.product_name === "Professional"
