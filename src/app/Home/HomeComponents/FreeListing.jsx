...
const FreeListing = ({ businesses }) => {
  ...
  const settings = {
    ...
    speed: 500,
    slidesToShow: Math.min(3, sliderData.length),
    slidesToScroll: Math.min(3, sliderData.length),
    arrows: true,
    responsive: [
      {
        breakpoint: 1024,
        settings: {
          slidesToShow: Math.min(2, sliderData.length),
          slidesToScroll: Math.min(2, sliderData.length),
          infinite: sliderData.length > 1,
          dots: false,
        },
      },
              ...
              >
                <div className="relative">
                  <Image
                    ...
                    alt={business?.first_name || "Business Image"}
                    width={500}
                    height={220}
                ...
                >
                  <h2 className="text-lg text-black">
                    {
                      business.first_name && business.first_name.length > 25
                  ...
                  <p className="text-gray-600">
                    {(() => {
                      ...
                      if (address) {
                        ...
                        // If no street address, combine city and state without extra comma
                        if (city && state) {
